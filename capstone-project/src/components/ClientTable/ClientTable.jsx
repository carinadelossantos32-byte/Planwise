                ...
                {!isArchived && (
                    <>
                        ...
                        <div className="stat-item">
                            ...
                            <span className="stat-value">
                                {safeClients.filter(c => c.status === "Active").length}
                            </span>
                        </div>
                    </>
                )}
                ...
                {loading ? (
                    ...
                    <>
                        <table className="table table-xs table-pin-rows table-pin-cols">
                            ...
                            <tbody>
                                {/* We map over 'currentClients' instead of all 'clients' */}
                                {currentClients.map((client, index) => (
                                    <tr key={client.id} className={isArchived ? "archived-row" : ""}>
                                        {/* Fix the ID so it continues numbering across pages correctly */}
