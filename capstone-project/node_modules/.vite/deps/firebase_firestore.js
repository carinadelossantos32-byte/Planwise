...
//#endregion
//#region node_modules/@firebase/firestore/dist/common-7a7519be.esm.js
/**
* @license
...
var __PRIVATE_WatchChangeAggregator = class {
	...
	*/
	et(e, t, n) {
		if (!this.rt(e)) return;
		const r = this.nt(e);
		this.Et(e, t) ? r.qe(t, 1) : r.Ue(t), this.He = this.He.insert(t, this.Rt(t).delete(e)), this.He = this.He.insert(t, this.Rt(t).add(e)), n && (this.je = this.je.insert(t, n));
	}
	removeTarget(e) {
		this.ze.delete(e);
	}
...
*/ var __PRIVATE_MemoryMutationQueue = class {
	constructor(e, t) {
		this.indexManager = e, this.referenceDelegate = t, this.mutationQueue = [], this.Yn = 1, this.Hr = new SortedSet(__PRIVATE_DocReference.Kr);
	}
	checkEmpty(e) {
...
var __PRIVATE_IndexedDbPersistence = class __PRIVATE_IndexedDbPersistence {
	...
	*/ Ji(e) {
	...
	async shutdown() {
		this.ui = !1, this._s(), this.Bi && (this.Bi.cancel(), this.Bi = null), this.us(), this.cs(), await this.qi.runTransaction("shutdown", "readwrite", [W, Ve], ((e) => {
	...
	*/ hs() {
	...
	runTransaction(e, t, n) {
		...
		let s;
		return this.qi.runTransaction(e, r, i, ((r) => (s = new __PRIVATE_IndexedDbTransaction(r, this.ai ? this.ai.next() : __PRIVATE_ListenSequence.ce), "readwrite-primary" === t ? this.ji(s).next(((e) => !!e || this.Ji(s))).next(((t) => {
	...
	*/ static u_() {
	...
	T_(e, t, n) {
		...
		return __PRIVATE_unguardedEventListen(u, WebChannel.EventType.OPEN, (() => {
			...
			l || (l = !0, __PRIVATE_logDebug(Gt, `RPC '${e}' stream ${r} transport closed`), h.o_(), this.E_(u));
...
var __PRIVATE_RemoteStoreImpl = class {
	constructor(e, t, n, r, i) {
		this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.Ta = [], this.Ia = /* @__PURE__ */ new Map(), this.Ea = /* @__PURE__ */ new Map(), this.Ra = /* @__PURE__ */ new Map(), this.Aa = new __PRIVATE_TargetIdGenerator(1e3), this.Va = new __PRIVATE_TargetIdGenerator(1001), this.da = /* @__PURE__ */ new Set(), this.ma = [], this.fa = i, this.fa.Mo(((e) => {
			n.enqueueAndForget((async () => {
				__PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug(jt, "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e) {
					const t = __PRIVATE_debugCast(e);
					t.da.add(4), await __PRIVATE_disableNetworkInternal(t), t.ga.set("Unknown"), t.da.delete(4), await __PRIVATE_enableNetworkInternal(t);
				}(this));
			}));
...
async function __PRIVATE_enableNetworkInternal(e) {
	if (__PRIVATE_canUseNetwork(e)) for (const t of e.ma) await t(!0);
}
/**
* Temporarily disables the network. The network can be re-enabled using
* enableNetwork().
*/ async function __PRIVATE_disableNetworkInternal(e) {
	for (const t of e.ma) await t(!1);
}
/**
...
function __PRIVATE_remoteStoreListen(e, t) {
	...
	const i = function __PRIVATE_allocateRemoteTargetId(e, t) {
		...
		void 0 !== n && e.Ra.delete(n);
		const r = function __PRIVATE_generateRemoteTargetId(e, t) {
			return t % 2 != 0 ? e.Va.next() : e.Aa.next();
		}(e, t);
		return e.Ea.set(t, r), e.Ra.set(r, t), r;
	}(n, t.targetId);
	...
	n.Ia.set(i, s), __PRIVATE_shouldStartWatchStream(n) ? __PRIVATE_startWatchStream(n) : __PRIVATE_ensureWatchStream(n).O_() && __PRIVATE_sendWatchRequest(n, s);
}
/**
...
*/ function __PRIVATE_remoteStoreUnlisten(e, t) {
	...
	__PRIVATE_logDebug(jt, "remoteStoreUnlisten removing mapping of SDK target ID to remote", t, i), n.Ia.delete(i), n.Ea.delete(t), n.Ra.delete(i), r.O_() && __PRIVATE_sendUnwatchRequest(n, i), 0 === n.Ia.size && (r.O_() ? r.L_() : __PRIVATE_canUseNetwork(n) && n.ga.set("Unknown"));
}
/**
...
*/ function __PRIVATE_sendWatchRequest(e, t) {
	if (e.pa.$e(t.targetId), t.resumeToken.approximateByteSize() > 0 || t.snapshotVersion.compareTo(SnapshotVersion.min()) > 0) {
		...
		if (void 0 === n) return void __PRIVATE_logDebug(jt, "SDK target ID not found for remote ID: " + t.targetId);
...
async function __PRIVATE_onWatchStreamClose(e, t) {
	__PRIVATE_cleanUpWatchStreamState(e), __PRIVATE_shouldStartWatchStream(e) ? (e.ga.ha(t), __PRIVATE_startWatchStream(e)) : e.ga.set("Unknown");
}
async function __PRIVATE_onWatchStreamChange(e, t, n) {
	if (e.ga.set("Online"), t instanceof __PRIVATE_WatchTargetChange && 2 === t.state && t.cause) try {
		...
		await async function __PRIVATE_handleTargetError(e, t) {
			...
			for (const r of t.targetIds) {
				if (e.Ia.has(r)) {
					const t = e.Ra.get(r);
					void 0 !== t && (await e.remoteSyncer.rejectListen(t, n), e.Ea.delete(t), e.Ra.delete(r)), e.Ia.delete(r);
				}
				e.pa.removeTarget(r);
			}
		}(e, t);
...
*/ async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
	...
	e.da.add(1), await __PRIVATE_disableNetworkInternal(e), e.ga.set("Offline"), n || (n = () => __PRIVATE_localStoreGetLastRemoteSnapshotVersion(e.localStore)), e.asyncQueue.enqueueRetryable((async () => {
		__PRIVATE_logDebug(jt, "Retrying IndexedDB access"), await n(), e.da.delete(1), await __PRIVATE_enableNetworkInternal(e);
	}));
}
/**
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
	...
	n.da.add(3), await __PRIVATE_disableNetworkInternal(n), r && n.ga.set("Unknown"), await n.remoteSyncer.handleCredentialChange(t), n.da.delete(3), await __PRIVATE_enableNetworkInternal(n);
}
/**
* Toggles the network state when the client gains or loses its primary lease.
*/ async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
	const n = __PRIVATE_debugCast(e);
	t ? (n.da.delete(2), await __PRIVATE_enableNetworkInternal(n)) : t || (n.da.add(2), await __PRIVATE_disableNetworkInternal(n), n.ga.set("Unknown"));
}
/**
...
*/ function __PRIVATE_ensureWatchStream(e) {
	return e.ya || (e.ya = function __PRIVATE_newPersistentWatchStream(e, t, n) {
		const r = __PRIVATE_debugCast(e);
		...
		t ? (e.ya.B_(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.ga.set("Unknown")) : (await e.ya.stop(), __PRIVATE_cleanUpWatchStreamState(e));
	}))), e.ya;
}
/**
...
*/ function __PRIVATE_ensureWriteStream(e) {
	return e.wa || (e.wa = function __PRIVATE_newPersistentWriteStream(e, t, n) {
		const r = __PRIVATE_debugCast(e);
		...
		t ? (e.wa.B_(), await __PRIVATE_fillWritePipeline(e)) : (await e.wa.stop(), e.Ta.length > 0 && (__PRIVATE_logDebug(jt, `Stopping write stream with ${e.Ta.length} pending writes`), e.Ta = []));
	}))), e.wa;
}
/**
* @license
...
*/ var __PRIVATE_DocumentChangeSet = class {
	...
	track(e) {
		...
		n ? 0 !== e.type && 3 === n.type ? this.Sa = this.Sa.insert(t, e) : 3 === e.type && 1 !== n.type ? this.Sa = this.Sa.insert(t, {
			type: n.type,
			doc: e.doc
	...
	terminate() {
		(function __PRIVATE_errorAllTargets(e, t) {
			...
			n.queries = __PRIVATE_newQueriesObjectMap(), r.forEach(((e, n) => {
				for (const e of n.va) e.onError(t);
			}));
...
async function __PRIVATE_eventManagerListen(e, t) {
	...
	s ? !s.Fa() && t.Ma() && (r = 2) : (s = new __PRIVATE_QueryListenersInfo(), r = t.Ma() ? 0 : 1);
	try {
		switch (r) {
			case 0:
	...
	if (n.queries.set(i, s), s.va.push(t), t.Oa(n.onlineState), s.Ca) t.Na(s.Ca) && __PRIVATE_raiseSnapshotsInSyncEvent(n);
}
async function __PRIVATE_eventManagerUnlisten(e, t) {
	...
	if (s) {
		const e = s.va.indexOf(t);
		e >= 0 && (s.va.splice(e, 1), 0 === s.va.length ? i = t.Ma() ? 0 : 1 : !s.Fa() && t.Ma() && (i = 2));
	}
	switch (i) {
...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
	...
	for (const e of t) {
		...
		if (i) {
			for (const t of i.va) t.Na(e) && (r = !0);
			i.Ca = e;
		}
	}
...
function __PRIVATE_eventManagerOnWatchError(e, t, n) {
	...
	if (i) for (const e of i.va) e.onError(n);
	r.queries.delete(t);
}
...
(Jt = Ht$1 || (Ht$1 = {})).Ba = "default", Jt.Cache = "cache";
/**
...
var __PRIVATE_QueryListener = class {
	constructor(e, t, n) {
		this.query = e, this.La = t, this.ka = !1, this.Ka = null, this.onlineState = "Unknown", this.options = n || {};
	}
	/**
	...
	*/ Na(e) {
		...
		let t = !1;
		return this.ka ? this.qa(e) && (this.La.next(e), t = !0) : this.Ua(e, this.onlineState) && (this.$a(e), t = !0), this.Ka = e, t;
	}
	onError(e) {
		this.La.error(e);
	}
	/** Returns whether a snapshot was raised. */ Oa(e) {
		this.onlineState = e;
		let t = !1;
		return this.Ka && !this.ka && this.Ua(this.Ka, e) && (this.$a(this.Ka), t = !0), t;
	}
	Ua(e, t) {
	...
	$a(e) {
		e = ViewSnapshot.fromInitialDocuments(e.query, e.docs, e.mutatedKeys, e.fromCache, e.hasCachedResults), this.ka = !0, this.La.next(e);
	}
	Ma() {
...
*/ var __PRIVATE_BundleLoader = class {
	constructor(e, t) {
		this.za = e, this.serializer = t, this.ja = [], this.Ja = [], this.collectionGroups = /* @__PURE__ */ new Set(), this.progress = __PRIVATE_bundleInitialProgress(e);
	}
	/**
	...
	*/ Ha(e) {
		...
		if (e.Qa.namedQuery) this.ja.push(e.Qa.namedQuery);
			...
			this.Ja.push({ metadata: e.Qa.documentMetadata }), e.Qa.documentMetadata.exists || ++t;
	...
	*/ async Xa(e) {
		...
		for (const t of this.ja) await __PRIVATE_localStoreSaveNamedQuery(e, t, n.get(t.name));
...
*/ var __PRIVATE_View = class {
	constructor(e, t) {
		this.query = e, this.tu = t, this.nu = null, this.hasCachedResults = !1, this.current = !1, this.ru = __PRIVATE_documentKeySet(), this.mutatedKeys = __PRIVATE_documentKeySet(), this.iu = __PRIVATE_newQueryComparator(e), this.su = new DocumentSet(this.iu);
	}
	/**
	...
	*/ _u(e, t) {
		...
		if (e.inorderTraversal(((e, t) => {
			...
			if (u && c) u.data.isEqual(c.data) ? l !== h && (n.track({
				type: 3,
				doc: c
			}), P = !0) : this.uu(u, c) || (n.track({
				type: 2,
				doc: c
			}), P = !0, (_ && this.iu(c, _) > 0 || a && this.iu(c, a) < 0) && (o = !0));
			else !u && c ? (n.track({
				type: 0,
				doc: c
			}), P = !0) : u && !c && (n.track({
	...
	*/
	applyChanges(e, t, n, r) {
		...
		}(e.type, t.type) || this.iu(e.doc, t.doc))), this.cu(n), r = r ?? !1;
		const o = t && !r ? this.lu() : [], _ = 0 === this.ru.size && this.current && !r ? 1 : 0, a = _ !== this.nu;
		if (this.nu = _, 0 !== s.length || a) return {
			snapshot: new ViewSnapshot(this.query, e.su, i, s, e.mutatedKeys, 0 === _, a, !1, !!n && n.resumeToken.approximateByteSize() > 0),
			hu: o
		};
		return { hu: o };
	}
	...
	*/ Pu(e) {
		return !this.tu.has(e) && !!this.su.has(e) && !this.su.get(e).hasLocalMutations;
	}
	/**
	* Updates syncedDocuments, current, and limbo docs based on the given change.
	* Returns the list of changes to which docs are in limbo.
	*/ cu(e) {
		e && (e.addedDocuments.forEach(((e) => this.tu = this.tu.add(e))), e.modifiedDocuments.forEach(((e) => {})), e.removedDocuments.forEach(((e) => this.tu = this.tu.delete(e))), this.current = e.current);
	}
	lu() {
		if (!this.current) return [];
		const e = this.ru;
		this.ru = __PRIVATE_documentKeySet(), this.su.forEach(((e) => {
			this.Pu(e.key) && (this.ru = this.ru.add(e.key));
		}));
		const t = [];
		return e.forEach(((e) => {
			this.ru.has(e) || t.push(new __PRIVATE_RemovedLimboDocument(e));
		})), this.ru.forEach(((n) => {
...
*/ var __PRIVATE_SyncEngineImpl = class {
	constructor(e, t, n, r, i, s) {
		this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.Ru = {}, this.Au = new ObjectMap(((e) => __PRIVATE_canonifyQuery(e)), __PRIVATE_queryEquals), this.Vu = /* @__PURE__ */ new Map(), this.du = /* @__PURE__ */ new Set(), this.mu = new SortedMap(DocumentKey.comparator), this.fu = /* @__PURE__ */ new Map(), this.gu = new __PRIVATE_ReferenceSet(), this.pu = {}, this.yu = /* @__PURE__ */ new Map(), this.wu = __PRIVATE_TargetIdGenerator.ar(), this.onlineState = "Unknown", this.Su = void 0;
	}
	get isPrimaryClient() {
		return !0 === this.Su;
	}
...
async function __PRIVATE_syncEngineListen(e, t, n = !0) {
	...
	let i;
	const s = r.Au.get(t);
	return s ? (r.sharedClientState.addLocalQueryTarget(s.targetId), i = s.view.Iu()) : i = await __PRIVATE_allocateTargetAndMaybeListen(
		r,
		t,
		n,
...
*/ async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
	e.bu = (t, n, r) => async function __PRIVATE_applyDocChanges(e, t, n, r) {
		let i = t.view._u(n);
		i.bs && (i = await __PRIVATE_localStoreExecuteQuery(e.localStore, t.query, !1).then((({ documents: e }) => t.view._u(e, i))));
		...
		return __PRIVATE_updateTrackedLimbos(e, t.targetId, _.hu), _.snapshot;
	}(e, t, n, r);
	const s = await __PRIVATE_localStoreExecuteQuery(e.localStore, t, !0), o = new __PRIVATE_View(t, s.ks), _ = o._u(s.documents), a = TargetChange.createSynthesizedTargetChangeForCurrentChange(n, r && "Offline" !== e.onlineState, i), u = o.applyChanges(_, e.isPrimaryClient, a);
...
/** Stops listening to the query. */ async function __PRIVATE_syncEngineUnlisten(e, t, n) {
	...
	if (s.length > 1) return r.Vu.set(i.targetId, s.filter(((e) => !__PRIVATE_queryEquals(e, t)))), void r.Au.delete(t);
...
*/ async function __PRIVATE_syncEngineWrite(e, t, n) {
	...
	try {
		...
		r.sharedClientState.addPendingMutation(e.batchId), function __PRIVATE_addMutationCallback(e, t, n) {
			let r = e.pu[e.currentUser.toKey()];
			r || (r = new SortedMap(__PRIVATE_primitiveComparator));
			r = r.insert(t, n), e.pu[e.currentUser.toKey()] = r;
...
*/ async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
	...
	try {
		...
		t.targetChanges.forEach(((e, t) => {
			const r = n.fu.get(t);
			r && (__PRIVATE_hardAssert(e.addedDocuments.size + e.modifiedDocuments.size + e.removedDocuments.size <= 1, 22616), e.addedDocuments.size > 0 ? r.Eu = !0 : e.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r.Eu, 14607) : e.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r.Eu, 42227), r.Eu = !1));
	...
	if (r.isPrimaryClient && 0 === n || !r.isPrimaryClient && 1 === n) {
		...
		r.Au.forEach(((n, r) => {
			...
			n.queries.forEach(((e, n) => {
				for (const e of n.va) e.Oa(t) && (r = !0);
			})), r && __PRIVATE_raiseSnapshotsInSyncEvent(n);
		}(r.eventManager, t), e.length && r.Ru.H_(e), r.onlineState = t, r.isPrimaryClient && r.sharedClientState.setOnlineState(t);
	}
}
/**
...
*/ async function __PRIVATE_syncEngineRejectListen(e, t, n) {
	...
	if (s) {
		...
		await __PRIVATE_syncEngineApplyRemoteEvent(r, new RemoteEvent(SnapshotVersion.min(), /* @__PURE__ */ new Map(), new SortedMap(__PRIVATE_primitiveComparator), e, n)), r.mu = r.mu.remove(s), r.fu.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r);
...
/** Reject all outstanding callbacks waiting for pending writes to complete. */ function __PRIVATE_processUserCallback(e, t, n) {
	...
	if (i) {
		const e = i.get(t);
		e && (n ? e.reject(n) : e.resolve(), i = i.remove(t)), r.pu[r.currentUser.toKey()] = i;
	}
}
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
	e.sharedClientState.removeLocalQueryTarget(t);
	for (const r of e.Vu.get(t)) e.Au.delete(r), n && e.Ru.Du(r, n);
	if (e.Vu.delete(t), e.isPrimaryClient) e.gu.Gr(t).forEach(((t) => {
		e.gu.containsKey(t) || __PRIVATE_removeLimboTarget(e, t);
	}));
}
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
	for (const r of n) if (r instanceof __PRIVATE_AddedLimboDocument) e.gu.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
		...
		e.gu.containsKey(r.key) || __PRIVATE_removeLimboTarget(e, r.key);
	} else fail(19791, { Cu: r });
}
...
async function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
	...
	r.Au.isEmpty() || (r.Au.forEach(((e, _) => {
		o.push(r.bu(_, t, n).then(((e) => {
	...
	})), await Promise.all(o), r.Ru.H_(i), await async function __PRIVATE_localStoreNotifyLocalViewChanges(e, t) {
		const n = __PRIVATE_debugCast(e);
		try {
...
*/ async function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
	const n = __PRIVATE_debugCast(e), r = await __PRIVATE_localStoreExecuteQuery(n.localStore, t.query, !0), i = t.view.Tu(r);
...
async function __PRIVATE_syncEngineApplyBatchState(e, t, n, r) {
	...
	}(i.localStore, t)) : fail(6720, "Unknown batchState", { vu: n }), await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(i, s)) : __PRIVATE_logDebug(Zt, "Cannot apply mutation batch with id: " + t);
}
/** Applies a query target change from a different tab. */
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
	const n = __PRIVATE_debugCast(e);
	if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), !0 === t && !0 !== n.Su) {
		const t = await __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(n, n.sharedClientState.getAllActiveQueryTargets().toArray());
		n.Su = !0, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, !0);
		...
		n.Vu.forEach(((r, i) => {
			...
			})), t.gu.zr(), t.fu = /* @__PURE__ */ new Map(), t.mu = new SortedMap(DocumentKey.comparator);
		}(n), n.Su = !1, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, !1);
	}
}
async function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
	...
	for (const e of t) {
		...
		if (n && 0 !== n.length) {
			...
			for (const e of n) {
				const n = await __PRIVATE_synchronizeViewAndComputeSnapshot(r, r.Au.get(e));
...
async function __PRIVATE_syncEngineApplyTargetState(e, t, n, r) {
	const i = __PRIVATE_debugCast(e);
	if (i.Su) return void __PRIVATE_logDebug(Zt, "Ignoring unexpected query state notification.");
	const s = i.Vu.get(t);
...
/** Adds or removes Watch targets for queries from different tabs. */ async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
	...
	if (r.Su) {
		for (const e of t) {
			if (r.Vu.has(e) && r.sharedClientState.isActiveQueryTarget(e)) {
		...
		for (const e of n) r.Vu.has(e) && await __PRIVATE_localStoreReleaseTarget(r.localStore, e, !1).then((() => {
...
*/ function __PRIVATE_syncEngineLoadBundle(e, t, n) {
	...
	(async function __PRIVATE_loadBundleImpl(e, t, n) {
		try {
			...
			let s = await t.Fu();
			for (; s;) {
				const e = await i.Ha(s);
				e && n._updateProgress(e), s = await t.Fu();
			}
			const o = await i.Xa(e.localStore);
			return await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, o.eu, void 0), await function __PRIVATE_localStoreSaveBundle(e, t) {
				const n = __PRIVATE_debugCast(e);
				return n.persistence.runTransaction("Save bundle", "readwrite", ((e) => n.Pi.saveBundleMetadata(e, t)));
			}(e.localStore, r), n._completeWith(o.progress), Promise.resolve(o.Ya);
		} catch (e) {
...
*/ var __PRIVATE_IndexedDbOfflineComponentProvider = class extends __PRIVATE_MemoryOfflineComponentProvider {
	constructor(e, t, n) {
		super(), this.Lu = e, this.cacheSizeBytes = t, this.forceOwnership = n, this.kind = "persistent", this.synchronizeTabs = !1;
	}
	async initialize(e) {
		await super.initialize(e), await this.Lu.initialize(this, e), await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Lu.syncEngine), await __PRIVATE_fillWritePipeline(this.Lu.remoteStore), await this.persistence.zi((() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve())));
	}
	Ou(e) {
		return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
	}
...
*/ var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
	constructor(e, t) {
		super(e, t, !1), this.Lu = e, this.cacheSizeBytes = t, this.synchronizeTabs = !0;
	}
	async initialize(e) {
		...
		this.sharedClientState instanceof __PRIVATE_WebStorageSharedClientState && (this.sharedClientState.syncEngine = {
			...
			await __PRIVATE_syncEngineApplyPrimaryState(this.Lu.syncEngine, e), this.gcScheduler && (e && !this.gcScheduler.started ? this.gcScheduler.start() : e || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e || this.indexBackfillerScheduler.stop());
		}));
	}
	Mu(e) {
...
*/ var OnlineComponentProvider = class {
	...
	async terminate() {
		await async function __PRIVATE_remoteStoreShutdown(e) {
			const t = __PRIVATE_debugCast(e);
			__PRIVATE_logDebug(jt, "RemoteStore shutting down."), t.da.add(5), await __PRIVATE_disableNetworkInternal(t), t.fa.shutdown(), t.ga.set("Unknown");
...
*/ var __PRIVATE_BundleReaderImpl = class {
	constructor(e, t) {
		this.qu = e, this.serializer = t, this.metadata = new __PRIVATE_Deferred(), this.buffer = new Uint8Array(), this.Uu = function __PRIVATE_newTextDecoder() {
			return new TextDecoder("utf-8");
		}(), this.$u().then(((e) => {
			e && e.Ga() ? this.metadata.resolve(e.Qa.metadata) : this.metadata.reject(/* @__PURE__ */ new Error(`The first element of the bundle is not a metadata, it is\n             ${JSON.stringify(e?.Qa)}`));
	...
	*/ async $u() {
	...
	/** First index of '{' from the underlying buffer. */ zu() {
	...
	*/ async Wu() {
		for (; this.zu() < 0;) if (await this.ju()) break;
	...
	*/ async Gu(e) {
		for (; this.buffer.length < e;) await this.ju() && this.Qu("Reached the end of bundle when more is expected.");
		const t = this.Uu.decode(this.buffer.slice(0, e));
		return this.buffer = this.buffer.slice(e), t;
	}
	Qu(e) {
		throw this.qu.cancel(), /* @__PURE__ */ new Error(`Invalid bundle format: ${e}`);
	}
	/**
...
var Transaction$2 = class {
	...
	recordVersion(e) {
		...
		if (e.isFoundDocument()) t = e.version;
			...
			if (!e.isNoDocument()) throw fail(50498, { Hu: e.constructor.name });
...
*/ var __PRIVATE_TransactionRunner = class {
	...
	/** Runs the transaction and sets the result on deferred. */ Xu() {
		this.Zu -= 1, this.Yu();
	}
	Yu() {
		this.M_.p_((async () => {
			const e = new Transaction$2(this.datastore), t = this.ec(e);
			t && t.then(((t) => {
...
/** Enables the network connection and re-enqueues all pending operations. */ function __PRIVATE_firestoreClientEnableNetwork(e) {
	return e.asyncQueue.enqueue((async () => {
		...
		return t.setNetworkEnabled(!0), function __PRIVATE_remoteStoreEnableNetwork(e) {
			const t = __PRIVATE_debugCast(e);
			return t.da.delete(0), __PRIVATE_enableNetworkInternal(t);
		}(n);
	}));
}
/** Disables the network connection. Pending operations will not complete. */ function __PRIVATE_firestoreClientDisableNetwork(e) {
	return e.asyncQueue.enqueue((async () => {
		...
		return t.setNetworkEnabled(!1), async function __PRIVATE_remoteStoreDisableNetwork(e) {
			const t = __PRIVATE_debugCast(e);
			t.da.add(0), await __PRIVATE_disableNetworkInternal(t), t.ga.set("Offline");
		}(n);
	}));
}
/**
...
function __PRIVATE_firestoreClientGetDocumentsFromLocalCache(e, t) {
	...
	return e.asyncQueue.enqueueAndForget((async () => async function __PRIVATE_executeQueryFromCache(e, t, n) {
		try {
			const r = await __PRIVATE_localStoreExecuteQuery(e, t, !0), i = new __PRIVATE_View(t, r.ks), s = i._u(r.documents), o = i.applyChanges(s, !1);
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
	...
	return e.asyncQueue.enqueueAndForget((async () => function __PRIVATE_addSnapshotsInSyncListener(e, t) {
		__PRIVATE_debugCast(e).xa.add(t), t.next();
	}(await __PRIVATE_getEventManager(e), n))), () => {
		n.Ku(), e.asyncQueue.enqueueAndForget((async () => function __PRIVATE_removeSnapshotsInSyncListener(e, t) {
			__PRIVATE_debugCast(e).xa.delete(t);
		}(await __PRIVATE_getEventManager(e), n)));
	};
}
/**
...
var __PRIVATE_AsyncQueueImpl = class {
	constructor(e = Promise.resolve()) {
		this.rc = [], this.sc = !1, this.oc = [], this._c = null, this.ac = !1, this.uc = !1, this.cc = [], this.M_ = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry"), this.lc = () => {
			const e = getDocument();
	...
	*/ async Ic() {
		if (0 !== this.rc.length) {
			...
			this.rc.length > 0 && this.M_.p_((() => this.Ic()));
		}
	}
	Tc(e) {
		const t = this.hc.then((() => (this.ac = !0, e().catch(((e) => {
			this._c = e, this.ac = !1;
	...
	enqueueAfterDelay(e, t, n) {
		this.Pc(), this.cc.indexOf(e) > -1 && (t = 0);
		const r = DelayedOperation.createAndSchedule(this, e, t, n, ((e) => this.Ec(e)));
		return this.oc.push(r), r;
	}
	Pc() {
		this._c && fail(47125, { Rc: __PRIVATE_getMessageOrStack(this._c) });
	}
	...
	* exists.
	*/ Vc(e) {
		for (const t of this.oc) if (t.timerId === e) return !0;
		return !1;
	}
	/**
	...
	*/ dc(e) {
		return this.Ac().then((() => {
			this.oc.sort(((e, t) => e.targetTimeMs - t.targetTimeMs));
	...
	*/ mc(e) {
	...
	/** Called once a DelayedOperation is run or canceled. */ Ec(e) {
...
/** A "context" object passed around while parsing user data. */ var __PRIVATE_ParseContextImpl = class __PRIVATE_ParseContextImpl {
	...
	*/
	constructor(e, t, n, r, i, s) {
		this.settings = e, this.databaseId = t, this.serializer = n, this.ignoreUndefinedProperties = r, void 0 === i && this.fc(), this.fieldTransforms = i || [], this.fieldMask = s || [];
	}
	get path() {
...
*/ var __PRIVATE_UserDataReader = class {
	...
	/** Creates a new top-level parse context. */ V(e, t, n, r = !1) {
		return new __PRIVATE_ParseContextImpl({
			dataSource: e,
			methodName: t,
			targetDoc: n,
...
var __PRIVATE_ArrayUnionFieldValueImpl = class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
	...
	_toFieldTransform(e) {
		const t = __PRIVATE_createSentinelChildContext(this, e, !0), r = new __PRIVATE_ArrayUnionTransformOperation(this.vc.map(((e) => __PRIVATE_parseData(e, t))));
...
var __PRIVATE_ArrayRemoveFieldValueImpl = class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
	...
	_toFieldTransform(e) {
		const t = __PRIVATE_createSentinelChildContext(this, e, !0), r = new __PRIVATE_ArrayRemoveTransformOperation(this.vc.map(((e) => __PRIVATE_parseData(e, t))));
		return new FieldTransform(e.path, r);
	}
	isEqual(e) {
 ...
 /**
	...
	*/
	return function __PRIVATE_parseSentinelFieldValue(e, t) {
		if (!__PRIVATE_isWrite(t.dataSource)) throw t.Dc(`${e._methodName}() can only be used with update() and set()`);
		if (!t.path) throw t.Dc(`${e._methodName}() is not currently supported inside arrays`);
	...
	if (t.path && t.fieldMask.push(t.path), e instanceof Array) {
		...
		return function __PRIVATE_parseArray(e, t) {
			...
			let r = 0;
			for (const i of e) {
				let e = __PRIVATE_parseData(i, t.bc(r));
	...
	return function __PRIVATE_parseScalarValue(e, t) {
		...
		if (e instanceof DocumentReference) {
			...
			if (!r.isEqual(n)) throw t.Dc(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);
...
var Ut = "@firebase/firestore", Ht = "4.14.1";
/**
* @license
* Copyright 2017 Google LLC
*
